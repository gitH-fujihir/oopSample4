...
public class Main {
    ...
    private static BasicInformation getBasicInformation(){
        ...
        return new BasicInformation(ReceiptController.STORE_NM_ITAKO,"恐山支店",c.getTime(),"2000","999-3456-0000","");
    }
    ...
    private static BasicInformation getBasicInformationYukari(){
        ...
        return new BasicInformation(ReceiptController.STORE_NM_YUKARI,null,c.getTime(),"5000","012-3456-0000","");
    }
    ...
    private static BasicInformation getBasicInformationMaki(){
        ...
        return new BasicInformation(ReceiptController.STORE_NM_MAKI,"東京支店",c.getTime(),"2000","03-0000-0000","東京都千代田区××０丁目");
    }
